...
<section class="py-5">
    <div class="container about-container">
        <div class="about-hero">
            <h1 class="about-title">About Smart Poultry Farm</h1>
        ...
        <div class="about-content">
            <div class="about-section">
                <h2 class="section-title">Welcome to Smart Poultry Farm Management System!</h2>
                <p class="about-text">
        ...
        <div class="contact-section">
            ...
            <a href="tel:+250780162188" class="contact-phone">
                <i class="fas fa-phone"></i> +250 780 162 188
            </a>
        </div>
    </div>
</section>