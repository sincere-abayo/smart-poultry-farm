    ...
    try {
        ...
        switch ($action) {
            ...
            case 'send_test_email':
                ...
                $body = $_POST['body'] ?? 'This is a test email from Smart Poultry Farm notification system.';
                $result = $notificationService->sendEmail($to, $subject, $body);
                break;

            case 'send_test_sms':
                $phone = $_POST['phone'] ?? '';
                $message = $_POST['message'] ?? 'Test SMS from Smart Poultry Farm notification system.';
...
<head>
    ...
    <title>Notification System Test - Smart Poultry Farm</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <p class="mb-0">Smart Poultry Farm - Email & SMS Testing Interface</p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <form id="email-test-form">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="email-subject"
                                    value="Test Email from Smart Poultry Farm">
                            </div>
                            <div class="mb-3">
                                <label for="email-body" class="form-label">Message Body</label>
                                <textarea class="form-control" id="email-body" rows="4"
                                    placeholder="Enter your test message...">This is a test email from the Smart Poultry Farm notification system. If you receive this email, the email configuration is working correctly!</textarea>
                            </div>
                        ...
                        <form id="sms-test-form">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="sms-message" rows="4"
                                    placeholder="Enter your test message...">Test SMS from Smart Poultry Farm notification system. If you receive this SMS, the SMS configuration is working correctly!</textarea>
                            </div>
