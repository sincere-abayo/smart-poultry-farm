	...
	<div class="card-body">
		<form action="" id="product-form">
            ...
            <div class="form-group">
				<label for="brand_id" class="control-label">Breed</label>
            ...
            ?>
                <div class="d-flex w-100 align-items-center img-item">
                    <span><img src="<?php echo base_url.$upload_path.'/'.$img ?>" width="150px" height="200px" style="object-fit:cover;" class="img-thumbnail" alt=""></span>
