	...
	<div class="card-body">
		<form action="" id="product-form">
			...
			<div class="form-group">
                ...
                <textarea name="product_name" cols="30" rows="2" class="form-control no-resize"><?php echo isset($product_name) ? $product_name : ''; ?></textarea>
			</div>

            <div class="form-group">
				<label for="description" class="control-label">Description</label>
                <textarea name="description" cols="30" rows="2" class="form-control no-resize summernote"><?php echo isset($description) ? $description : ''; ?></textarea>
			</div>
