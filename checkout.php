                    ...
                    <div class="row row-col-1 justify-content-center">
                        <div class="col-6">
                            ...
                            <div class="form-group col address-holder">
                                ...
                                <textarea cols="30" rows="3" name="delivery_address" class="form-control" style="resize:none"><?php echo $_settings->userdata('default_delivery_address') ?></textarea>
                            </div>
                            <div class="col">
                            ...
                            <div class="col my-3">
                                ...
                                <div class="d-flex flex-column">
                                    <button type="submit" class="btn btn-flat btn-dark mb-2" onclick="setCOD()">Cash on Delivery</button>

                                    <div class="mb-2">
                                        <label for="momo_number">Enter MoMo Number</label>
                                        <input type="text" name="momo_number" id="momo_number" class="form-control" placeholder="07XXXXXXXX" />
                                        <button type="button" class="btn btn-success mt-2" onclick="payWithMomo()">Pay with MoMo</button>
                                    </div>
...
function payWithMomo(){
    ...
    $('[name="payment_method"]').val("MoMoPay")
    $('[name="paid"]').val(1)
    $('#place_order').submit()
}
